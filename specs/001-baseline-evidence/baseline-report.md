...
> **خط أساس تاريخي — تفسير النشر مستبدل منذ 2026-08-10.** تبقى قياسات raw أدناه
> صحيحة للالتزام المحدد، لكن اعتبارها مقارنة مباشرة بحد نشر سلة، وحكم التجاوز الخام،
> وهدف 85% السابق كلها `SUPERSEDED`. بوابة HDL-05 الحالية تقيس حزمة الثيم المضغوطة
> المقدّرة، مع إبقاء raw/gzip/network/runtime كقياسات مستقلة.
